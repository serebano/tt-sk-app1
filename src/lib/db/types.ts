...
export interface Database {
  public: {
    ...
    Views: {
      events: {
        Row: {
          action_user_full_name: string | null
          action_user_id: string | null
          action_user_image_url: string | null
      ...
      events_v2: {
        Row: {
          ...
          action_user_image_url: string | null
          action_user_name: string | null
          commennt_text: string | null
          created_at: string | null
          is_following: boolean | null
          receiver_user_full_name: string | null
          receiver_user_id: string | null
          receiver_user_image_url: string | null
